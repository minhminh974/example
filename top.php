            <div class="navbar nav_title" style="border: 0;"><a href="trang_quan_tri.php" class="site_title"><i class="fa fa-paw"></i> <span>ANIME97!</span></a></div>
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i> Quản trị Tổng hợp <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="quan_tri_menu.php">Cập nhật Menu</a></li>
                  ...
                  <li><a><i class="fa fa-desktop"></i> Quản trị Tin tức <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="bai_viet_quan_tri.php">Quản trị tin tức</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-table"></i> Quản trị Sản phẩm <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="san_pham_them_moi.php">Tạo sản phẩm mới</a></li>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="images/img.jpg" alt="">Văn Huy
